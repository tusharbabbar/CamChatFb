...
get '/chat/get_user_profile/:other_fb_id/:fb_id/:fb_access_token' do 
	User.get_user_profile(params["other_fb_id"],params["fb_id"],params["fb_access_token"])
end

get '/chat/get_user_about/:other_fb_id/:fb_id/:fb_access_token' do 
	User.get_user_about(params["other_fb_id"],params["fb_id"],params["fb_access_token"])
end

get '/chat/get_user_photos/:other_fb_id/:fb_id/:fb_access_token' do 
	User.get_user_photos(params["other_fb_id"],params["fb_id"],params["fb_access_token"])
end

get '/chat/get_user_movies/:other_fb_id/:fb_id/:fb_access_token' do 
	User.get_user_movies(params["other_fb_id"],params["fb_id"],params["fb_access_token"])
end
get '/chat/get_user_music/:other_fb_id/:fb_id/:fb_access_token' do 
	User.get_user_music(params["other_fb_id"],params["fb_id"],params["fb_access_token"])	
end
